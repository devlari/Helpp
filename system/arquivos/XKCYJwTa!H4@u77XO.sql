...
--
-- Host: 127.0.0.1
-- Tempo de geração: 11-Dez-2020 às 23:37
...
('170381', 65, '180115', 'Informática', '2º SEM', '2019', NULL, '2ª SÉRIE', 'Em aberto', 'MATEMÁTICA', 'aaaaaaaaa', 'aaaa', 'aaaaaaaaaaaaaaa', NULL),
...
('180057', 'JOÃO VITOR CARDOSO GOLIN', '', 'senha', 'Aluno'),
...
--
ALTER TABLE `disciplina`
  MODIFY `codDisciplina` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=73;

--
-- AUTO_INCREMENT de tabela `turma`
--
ALTER TABLE `turma`
  MODIFY `cod_turma` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=54;
